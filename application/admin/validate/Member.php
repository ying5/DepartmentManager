...
class Member extends Validate{
	...
	protected $rule = array(
		...
		'm_card'    => ['regex' =>'/^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{4}$/'],
                ...
                'm_department'=> 'length:6,90',
                'm_title'   => 'length:6,30',
                'm_province'=> 'length:6,60',
                'm_city'    => 'length:6,60',
                'm_address' => 'length:6,120',
	...
	protected $message = array(
		...
		'username.max'    => '登录名最大长度为40个字符',
		'username.min'    => '登录名最小长度为2个字符',
		//'m_email.email'  => '登录名必须为邮件格式',
		'password.require'  => '密码必须填写',
		'password.max'      => '密码最大长度为30个字符',
